...
<head>
  ...
  <!-- Bootstrap 3.3.7 -->
  <link rel="stylesheet" href="<?php echo e(asset('css/bootstrap/dist/css/bootstrap.min.css')); ?>">
  <!-- Font Awesome -->
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?php echo e(asset('css/morris.js/morris.css')); ?>">
  <!-- Scafolding-->
  <link rel="stylesheet" href="<?php echo e(asset('css/bootstrap/less/scaffolding.less')); ?>">
  <!-- jvectormap -->
  ...
  <link rel="stylesheet" href="<?php echo e(asset('css/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css')); ?>">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo e(asset('img/pr.jpg')); ?>" class="user-image" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="<?php echo e(asset('img/pr.jpg')); ?>" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?php echo e(route('show.companies')); ?>">
            <i class="fa fa-building"></i> <span>Companies</span>
          </a>
        </li>
        <li>
          <a href="<?php echo e(route('show.licenses')); ?>">
