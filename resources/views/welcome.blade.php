...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/main_start.css') }}">
    <script src="{{ asset('js/modernizr.js') }}"></script>
    <script src="{{ asset('js/pace.min.js') }}"></script>
    <link rel="icon" type="image/png" href="{{ asset('favicon.ico') }}">
</head>
<body id="top">
    <section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="{{ asset('img/platilla3-01.jpg') }}" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
