...
<head>
    ...
    <title>@yield('title' ,'WDStorages')</title>
    ...
    <!-- WDStorages Skins. Choose a skin from the css/skins folder instead of downloading all of them to reduce the load. -->
...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2019 <a href="https://warriorslabs.com/">Warrior Labs</a>.</strong> All rights reserved.
        </footer> 
    ...
    <!-- WDStorages dashboard demo (This is only for demo purposes) -->
    <script src="{{ asset('js/dashboard.js') }}"></script>
    <!-- WDStorages for demo purposes -->
